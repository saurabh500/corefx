...
namespace System.Data.SqlClient.Tests
{
    public class BenchMark
    {
        ...
        {
            string connectionString = "server=tcp:ss-desktop2,1437;uid=saurabh;pwd=HappyPass321;MultipleActiveResultSets=True;Initial Catalog=NorthWind;";
...
ORDER BY [c].[CustomerID], [c].[Country]";
        ...
        public async Task TestBenchMarkAsync()
        {
            ...
            var connectionString = "Data Source=ss-desktop2; uid=saurabh; pwd=HappyPass321; Initial Catalog=fortune; MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true";
                ...
                yield return Task.Run(
                    async () =>
                    {
                        ...
                        while (IsRunning)
                        {
                            ...
                            Console.WriteLine($"{tps} tps, {remaining}s                     ");
                            //Console.SetCursorPosition(0, Console.CursorTop);
